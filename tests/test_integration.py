...
class TestEncodingDetection:
    ...
    def test_detect_utf8_encoding(self):
        ...
        try:
            ...
            assert detected.upper() in ['UTF-8', 'UTF8'], f"Expected UTF-8, got {detected}"
    ...
    def test_detect_latin1_encoding(self):
        ...
        try:
            detected = detect_encoding(temp_path)
            # Detection might return latin-1, iso-8859-1, or windows-1252
            assert detected.upper() in ['ISO-8859-1', 'WINDOWS-1252', 'LATIN-1', 'LATIN1'], \
    ...
    def test_detect_windows1252_encoding(self):
        ...
        try:
            ...
            assert detected.upper() in ['WINDOWS-1252', 'ISO-8859-1', 'LATIN-1'], \
    ...
    def test_detect_ascii_encoding(self):
        ...
        try:
            ...
            assert detected.upper() in ['ASCII', 'UTF-8', 'UTF8', 'US-ASCII', 'WINDOWS-1252', 'ISO-8859-1'], \
    ...
    def test_detect_utf16_encoding(self):
        ...
        try:
            detected = detect_encoding(temp_path)
            # Should detect as UTF-16
            assert 'UTF-16' in detected.upper(), f"Expected UTF-16, got {detected}"
